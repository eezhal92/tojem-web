...
var _POSCart = __webpack_require__(17);
...
var _POSCartItem = __webpack_require__(37);
...
exports.default = {
  ...
  methods: {
    ...
    validatePayment: function validatePayment(changes) {
    ...
    pay: function pay() {
      ...
      var changes = parseInt(this.cash, 10) - this.total;
...
Component.options.__file = "resource/js/components/POSCartItem.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-05fe7881", Component.options)
  } else {
    hotAPI.reload("data-v-05fe7881", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "pos-cart-item border-grey p-2 my-2 rounded-lg mt-border border-grey bg-white"
    },
    [
      _c("span", [
        _vm._v(
          _vm._s(_vm.item.name) +
            " @ " +
            _vm._s(_vm._f("rupiah")(_vm.item.price))
        )
      ]),
      _vm._v(" "),
      ...
      _c("span", { staticClass: "float-right" }, [
        _c("input", {
          ...
          staticClass: "p-1 border border-grey",
    ...
    [
      _c(
        "div",
        {
          ...
          staticClass:
            "bg-red-lightest border-l-4 border-red text-red-dark p-4",
          attrs: { role: "alert" }
        },
        [
          _c("p", { staticClass: "font-bold" }, [_vm._v("Gagal")]),
          _vm._v(" "),
      ...
      _c(
        ...
        [_c("div", { staticClass: "py-4" }, [_vm._v("Belum ada barang.")])]
      ),
      _vm._v(" "),
      ...
      _vm._v(" "),
      _c("div", { staticClass: "cart-amount my-2" }, [
        _c("div", [
          _c("strong", [
            _vm._v("Grand Total: "),
            _c("span", { staticClass: "float-right" }, [
              _vm._v(_vm._s(_vm._f("rupiah")(_vm.total)))
            ])
          ])
        ]),
        _vm._v(" "),
      ...
      _c("div", [
        _c("strong", [
          _vm._v("Kembali"),
          _c("span", { staticClass: "float-right" }, [
            _vm._v(_vm._s(_vm._f("rupiah")(_vm.changes)))
          ])
        ])
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "cart-action" }, [
        _c(
          ...
          {
            staticClass:
              "font-semibold rounded-full px-4 py-1 leading-normal bg-white border border-blue text-blue hover:bg-blue hover:text-white",
        ...
        _c(
          ...
          {
            staticClass:
              "font-semibold rounded-full px-4 py-1 leading-normal bg-blue border border-blue text-white hover:bg-blue hover:text-white",
            on: { click: _vm.pay }
          },
          [_vm._v("Bayar")]
        )
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      ...
      {
        staticClass:
          "p-2 bg-white border border-dashed rounded-lg border-grey text-grey"
      },
      [
        _vm._v("\n    Tambah "),
        _c("div", { staticClass: "float-right" }, [_vm._v("+")])
      ]
    )
  }
]
...
var _ProductItem = __webpack_require__(43);
  ...
  return _c("div", { staticClass: "product-item" }, [
    ...
    _c("div", [
      _c(
        ...
        {
          staticClass:
            "bg-white text-xs hover:bg-blue-dark text-blue border border-blue font-bold py-2 px-4 rounded-full",
